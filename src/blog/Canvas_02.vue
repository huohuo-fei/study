...
<template>
  <div class="container">
    <div class="blog">
      ...
      <p>
        在上一篇分析相对变换与绝对变换的文章中，我们在讨论canvas的`transform`,说它是基于当前变换而变换的，基于一词，可以理解为
      ...
      <p>
        先引入一个案例：基于一个
        50*50的矩形，先平移(150,100),再旋转45°，再缩放(2，3)
      </p>
      ...
      <p>
        ...
        轴的缩放，a、b、c、d整体描述旋转的量，如果对详细的推导感兴趣，可以戳
        <a
      ...
      <p>
        ...
        + y sin(a),-xsin(a) + ycos(a)），可以简化为圆上任意一点绕圆心做旋转。而x
        y 单位长度不一样的旋转，可以简化为 椭圆任意一点，绕圆心做旋转。
      </p>
