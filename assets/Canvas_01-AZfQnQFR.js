import{d as i,r as n,o as v,c as g,a,p as x,q as u,g as m,s as h,b as l,f as R,_ as p}from"./index-S-0Wowcn.js";const b={class:"container"},_={class:"blog"},y={class:"box"},S=i({__name:"Canvas_01",setup(C){const s=n(),r=n();function c(){if(!s.value)return;const t=s.value.getContext("2d");t.fillStyle="rgba(200,200,200,1)",t.fillRect(0,0,s.value.width,s.value.height),t.fillStyle="rgba(100,100,100,1)",t.transform(1,0,0,1,50,50),t.fillRect(0,0,50,50),t.fillStyle="rgba(100,100,100,0.6)",t.transform(1,0,0,1,50,50),t.fillRect(0,0,50,50),t.save(),t.fillStyle="rgba(100,100,100,0.3)",t.transform(1,0,0,1,50,50),t.fillRect(0,0,50,50),t.restore()}function o(){if(!r.value)return;const t=r.value.getContext("2d");t.fillStyle="rgba(200,200,200,1)",t.fillRect(0,0,r.value.width,r.value.height),t.fillStyle="rgba(100,100,100,1)",t.setTransform(1,0,0,1,50,50),t.fillRect(0,0,50,50),t.fillStyle="rgba(255,255,2,0.6)",t.setTransform(1,0,0,1,50,50),t.fillRect(0,0,70,70),t.fillStyle="rgba(100,100,100,0.3)",t.setTransform(1,0,0,1,100,100),t.fillRect(0,0,50,50)}v(()=>{c(),o()});let f=` /** transform **/
// 三个矩形
